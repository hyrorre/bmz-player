...
/// LuaSkinLoader �� Java �� String �t�B�[���h�� Lua �̐��l��n���� `tojstring()` ��
/// �����񉻂���BModernChic �� category ID �ɐ��l���g�����߁A������ JSON decode ��
/// �O�ɓ����ϊ����s���B
...
/// LuaSkinLoader �� boolean �ϊ��� Lua �� truthiness (`toboolean`) �ɏ]���B
/// Lua �ł͐��l�� 0 �� true �Ȃ̂ŁAJSON �� 0/1 ����ɂ͂��Ȃ��B
