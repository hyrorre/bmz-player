...
5. Include `THIRD-PARTY-NOTICES.txt`, `rust-dependency-licenses.txt`, the Noto Sans CJK OFL text, FFmpeg, ASIO SDK, and bundled-skin notices in the release package.
