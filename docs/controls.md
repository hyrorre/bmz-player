...
| Scratch Up | カーソル上 | レーンカバー上げ | - | - |
| Scratch Down | カーソル下 | レーンカバー下げ | - | - |
...
| R | 同配置でリトライ |
| Enter / Escape | 選曲へ戻る |
| KEY1-KEY4 | 終了アニメーション後に選曲へ戻る |
| KEY5 | 終了アニメーション後に別配置でリトライ |
| KEY6 | ゲージグラフ種別を切替 |
| KEY7 | 終了アニメーション後に同配置でリトライ |
